...
If you want to disable reminders for individual bugs, reply with the
following command:
#syz skip: bug-title
...
> 2       No    WARNING: a fourth
>               https://testapp.appspot.com/bug?extid=%[4]v
#syz skip: WARNING: a fourth
> 2       No    WARNING: a second
>               https://testapp.appspot.com/bug?extid=%[2]v
> 2       No    WARNING: a third
>               https://testapp.appspot.com/bug?extid=%[3]v
#syz skip: WARNING: a third
`)
