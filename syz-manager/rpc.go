...
func (serv *RPCServer) runCheck(checkFilesInfo []flatrpc.FileInfo) {
	if err := serv.finishCheck(checkFilesInfo); err != nil {
...
func (serv *RPCServer) finishCheck(checkFilesInfo []flatrpc.FileInfo) error {
	// Note: need to print disbled syscalls before failing due to an error.
	// This helps to debug "all system calls are disabled".

	enabledCalls, disabledCalls, features, checkErr := serv.checker.Run(checkFilesInfo, serv.checkFeatureInfo)
